...
class TestMprmRest:
    ...
    def test_get_binary_switch_state_invalid(self, mock_gateway, mock_inspect_devices, mock_mprmrest__detect_gateway_in_lan):
        mprm = MprmRest(self.gateway_id)

        with pytest.raises(ValueError):
            mprm.get_binary_switch_state("invalid")

    def test_get_consumption_invalid(self, mock_gateway, mock_inspect_devices, mock_mprmrest__detect_gateway_in_lan):
        mprm = MprmRest(self.gateway_id)
    ...
    def test_get_voltage_invalid(self, mock_gateway, mock_inspect_devices, mock_mprmrest__detect_gateway_in_lan):
        mprm = MprmRest(self.gateway_id)
