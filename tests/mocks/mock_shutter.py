...
def shutter(device_uid: str) -> Zwave:
    ...
    device.multi_level_switch_property[f'devolo.Blinds:{device_uid}'] = \
        MultiLevelSwitchProperty(element_uid=f"devolo.Blinds:{device_uid}",
    ...
    device.settings_property['i2'] = \
        SettingsProperty(element_uid=f"bas.{device_uid}",
                         setter=lambda uid, state: None,
